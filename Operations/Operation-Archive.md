...
> **Technical record note:** The technical record is authoritative. The Committee dialogue is also authoritative, but for entirely different reasons.
...
| [Operation The Fan Was Fine, Ubuntu Was Just Vibes](/Operations/Operation-the-fan-was-fine-ubuntu-was-just-vibes) | Completed | Reese thermal management | Reopened the thermal investigation after CPU temperatures exceeded 100°C, identified the missing Apple-specific fan-control layer under Ubuntu, and restored stable temperatures with macfanctld. | No |
| [Operation The Router Has Decided Who Deserves Bandwidth](/Operations/Operation-the-router-has-decided-who-deserves-bandwidth) | Completed | Router QoS and network performance | Documented the QoS incident where enabling the feature reduced throughput and disabling it restored performance, with the router becoming an overworked packet bureaucracy. | No |
...
| [Operation No More Colon Crimes](/Operations/Operation-no-more-colon-crimes) | Active foundation completed | Friendly service naming | Established the documented DNS-plus-reverse-proxy model for replacing routine host-and-port navigation; implementation and validation remain active. | No |
| [Operation Reception Desk](/Operations/Operation-reception-desk) | Active foundation completed; refinement ongoing | Caddy and service routing | Established Caddy's intended reception role and separated DNS, Tailscale transport, and hostname-based backend routing; deployment and per-route validation remain active or planned. | No |
...
| [Operation Why Is My 1080p Radarr Hoarding 4K Movies](/Operations/Operation-why-is-my-1080p-radarr-hoarding-4k-movies) | Completed | Media request routing and Radarr quality profiles | Documented the Seerr request override that routed a movie into Radarr1080 with an Ultra-HD profile and required reassignment to Radarr4K. | No |
| [Operation One Does Not Simply Migrate Plex](/Operations/Operation-one-does-not-simply-migrate-plex) | Completed | Plex migration from Fusco to Reese | Documented the migration of Plex to Reese, including preparation, backups, path and mount checks, validation, and the unexpectedly easy handover. | No |
| [Operation I Swear We Automated This](/Operations/Operation-i-swear-we-automated-this) | Completed; recurring lessons | Monitoring stack persistence and automation | Documented the move from manually started monitoring components to persistent systemd-managed services, with reboot validation and recurring automation lessons. | No |
| [Operation: The Thirty-Six-Hour Goal That Was Scored, Rescinded, Scored Again, and Eventually Entered Library Folklore](/Operations/Operation-the-thirty-six-hour-goal) | Completed; goal stands | Backups and HealthMonitor | Replaced a roughly 36,000-file, 19GB off-site sync with one approximately 1.2GB weekly archive, added truthful HealthMonitor reporting, and survived a thirty-six-hour goal review. | No |
