...
| Operation Preventative Existential Crisis | Unknown; recurring | Weekly maintenance; homelab services | Used as the title for the Saturday maintenance runbook. | Recurring checks documented in the existing runbook. | Confirmed | No; use the runbook |
| Operation Why Is My 1080p Radarr Hoarding 4K Movies | Unknown | Radarr; media library | Recovered operation name suggests an unwanted quality or acquisition issue; no reliable details recovered. | Unknown | Fragment only | Yes |
